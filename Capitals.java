...
public class Capitals implements Questions{
    ...
    public String getQuestion(int point) {
        String question="";
        try {
            String query = "SELECT * FROM capital WHERE point="+point+" ORDER BY RAND() limit 1";
    ...
    public boolean verifyAnswer(String answer) {
        String correct="";
        try {
            String query = "SELECT * FROM capital WHERE id="+id+"";
            resultSet = statement.executeQuery(query);
    ...
    public String[] getVariants() {
        ...
        try {
            String query = "SELECT * FROM capitalvariants WHERE id="+id+"";
            resultSet = statement.executeQuery(query);
