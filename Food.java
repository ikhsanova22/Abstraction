...
public class Food implements Questions{
    ...
    public String getQuestion(int point) {
        String question="";
        try {
            String query = "SELECT * FROM food WHERE point="+point+" ORDER BY RAND() limit 1";
    ...
    public String[] getVariants() {
        ...
        try {
            String query = "SELECT * FROM foodvariants WHERE id="+id+"";
            resultSet = statement.executeQuery(query);
