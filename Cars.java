...
public class Cars implements Questions{
    ...
    public String getQuestion(int point) {
        String question="";
        try {
            String query = "SELECT * FROM car WHERE point="+point+" ORDER BY RAND() limit 1";
    ...
    public String[] getVariants() {
        ...
        try {
            String query = "SELECT * FROM carvariants WHERE id="+id+"";
            resultSet = statement.executeQuery(query);
